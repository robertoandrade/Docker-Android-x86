...
RUN cd android-sdk-linux/tools/;./android -s update sdk --no-ui --filter 1,2,3,10,19,20,22,40,42,56,58,60,61,63,65,79,80,102,103,112,113,118,119,120,121,122,123,124
